package www.wanfin.com.demo.aspect;
...
public class MassageAspect {
	...
	/*
	@After("execution(* www.wanfin.com.demo.bussiness..*Recv(..)) && !execution(* www.wanfin.com.demo.bussiness..DeadRecv(..))")
